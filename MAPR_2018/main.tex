...
\title[MAPR Conference 2018] % [] is optional - is placed on the bottom of the sidebar on every slide
{ % is placed on the title page
      \textbf{Landmarks Detection by Applying \\Deep Networks}
}
...
\date[MAPR Conference 2018]{\textbf{MAPR Conference}\\Ho Chi Minh City, 5-6 April, 2018}
%\date{\today}
...
\begin{block}{Morphometry analysis}
  ...
  \begin{itemize}
     ...
     \item A specific point defined by biologist. For example, intersection of viens on fly wing, the tip of beetle's mandible,\ldots
  \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}{Proposed method}{Network architecture}
  \begin{columns}
		\begin{column}{0.45\textwidth}	
			...
			\small{
			\begin{itemize}
				\item Has the same architecture with the first one,
    			\item Modify the output of FC layers,
		...
		\begin{column}{0.6\textwidth}  %%<--- here
    		...
    		\begin{center}
     			\begin{figure}[htbp]
        			\centering
        			\includegraphics[scale=.44]{images/architecture2}
        			%\caption{\footnotesize{Pronotum}}
    				\label{figrsexample1}
				\end{figure}
     		\end{center}
     		...
     		\begin{center}
     			\begin{figure}[htbp]
        			\centering
        			\includegraphics[scale=.4]{images/architecture3}
        			%\caption{\footnotesize{Pronotum}}
    				\label{figrsexample1}
				\end{figure}
     		\end{center}
