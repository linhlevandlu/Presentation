...
\begin{frame}{Training}{}
	\begin{itemize}
		...
		\item Apply the cross-validation to select the tranining data
...
\begin{frame}{Fine-tuning our model}{}
	...
	\begin{itemize}
		...
		\item Train the model on a dataset including the images of $3$ parts of beetles \only<2>{\textbf{($5,460$ images)}}: head, body and pronotum parts
