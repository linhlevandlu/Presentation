...
%-------------------------------------------------------
%-------------------------------------------------------
\begin{frame}{Our proposed architecture}{}
  \begin{columns}
		\begin{column}{0.45\textwidth}	
			...
			\small{
			\begin{itemize}
				\item A {\color{orange}CONV} layer,
    			\item A {\color{yellow}maxixum POOLING} layer,
    			\item A {\color{green}DROPOUT} layer
  			\end{itemize}}  			
  			}			 			
		\end{column}
...
\begin{frame}{Data augmentation}{}
	...
	\begin{itemize}
		...
		\only<2>{\item Split the channels.}
	\end{itemize}
	}
...
\begin{frame}{Fine-tuning our model}{}
	...
	\begin{itemize}
		...
		\item Train the model on a dataset including the images of $3$ parts of beetles \only<2>{\textbf{($5,460$ images)}}
