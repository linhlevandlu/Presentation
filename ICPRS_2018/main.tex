...
\begin{frame}{Training}{}
	\begin{itemize}
		\item Training parameters: momentum ($0.9 \rightarrow 0.9999$), learing rate ($0.03 \rightarrow 0.00001$), $5,000$ epochs\footnotemark
...
\begin{frame}{Fine-tuning our model}{}
	\only<1-3>{	
	\begin{itemize}
		\item Train the model on a dataset including the images of $3$ parts of beetles ($5,460$ images)
	...
	\begin{center}
     \begin{figure}[htbp]
        \includegraphics[scale=.45]{images/merge}
    	\label{figrsexample1}
	 \end{figure}
    \end{center}
    }
    ...
    \begin{center}
     \begin{figure}[htbp]
        \includegraphics[scale=.45]{images/merge_rm}
    	\label{figrsexample1}
	 \end{figure}
    \end{center}
    }
...
%-------------------------------------------------------
\section{Results}
\begin{frame}{Results}{Average distance comparing}
	\only<1>{
	The average distances of all images per landmark.
	\begin{table}[htbp]
		\centering
		\begin{tabular}{|c|c|}
			\hline
	...
	\begin{table}[htbp]
	 ...
	 & Average & SD & Average & SD \  \\ \hline
			...
			\color{green}{\textbf{LM6}} & \color{green}{\textbf{5.3631}} & \color{green}{\textbf{3.4234}} & \color{green}{\textbf{3.0492}} & \color{green}{\textbf{1.991}} \\ \hline
